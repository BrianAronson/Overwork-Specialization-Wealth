...
proc import datafile="C:/Users/bda13/Desktop/Sociology/Statistics/SCF/SCF Full Data Files/uqrregres1919Stocks.csv"
     out=rreg
     dbms=csv
	 replace;
run;
...
proc export 
	  data=work.temp
	  dbms=xlsx 
	  outfile="C:\Users\bda13\Desktop\Sociology\Papers in Progress\Work Hours\Archived tables\uqrstocks.xlsx" 
	  replace;
run;
