...
*Table 1 - Descriptive Stats;
		...
		proc export 
			  data=work.temp
			  dbms=xlsx 
			  outfile="C:\Users\bda13\Desktop\temp" 
			  replace;
		run;
****************************************************
...
*Table 2 - Quantile Regression;
		...
		proc quantreg data=scftemp algorithm=simplex ci=resampling;
			model loggednetworth=HSGraduate SomeCollege Bachelors AdvancedDegree black latino other Married Separated Divorced Widowed LivingWithPartner age agesquared Children ChildrenSquared year1 HeadWorkHoursOver40 year1*HeadWorkHoursOver40 HomemakerSpouse HeadWorkHoursOver40*HomemakerSpouse
...
*Stats for figures (quantile regression for other wealth components:
	*4a - HomeEquity;
		...
		*	by quantile;
		...
		proc export 
			  data=work.temp
			  dbms=xlsx 
			  outfile="C:\Users\bdaro_000\Desktop\tempho" 
			  replace;
		run;
	...
	*4b - Financial assets;
		...
		proc export 
			  data=work.temp
			  dbms=xlsx 
			  outfile="C:\Users\bdaro_000\Desktop\tempfa" 
			  replace;
		run;
...
*logistic regressions;
	...
	run;
	*HomeOwner hstocks IRAor401k InterestBank;
...
*to import and run from R;
proc import datafile="C:/Users/bda13/Desktop/Sociology/Statistics/SCF/SCF Full Data Files/uqrregres.csv"
     out=rreg
     dbms=csv;
run;
...
run;
		proc mianalyze parms=Rreg;
		    modeleffects HSGraduate SomeCollege Bachelors AdvancedDegree black latino other Married Separated Divorced Widowed LivingWithPartner age agesquared Children ChildrenSquared year1 HeadWorkHoursOver40 HomemakerSpouse ;
			by quantile;
			Title "2 - Quantile Regression";
			ods output ParameterEstimates=temp;
		run;
